...
import { 
  ...
  Pagination, Spin, message, Modal, InputNumber, Switch, Divider 
} from 'antd';
import { 
...
export const ProductCatalog: React.FC = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Only add inStock filter if showOutOfStock is false
      if (!showOutOfStock) {
              ...
              <Col xs={24} md={12}>
                <Space direction="vertical" size="middle" className="w-full">
                  ...
                  <Space wrap size="small">
                    ...
                    {selectedProduct.stock_quantity <= selectedProduct.minimum_stock && selectedProduct.stock_quantity > 0 && (
